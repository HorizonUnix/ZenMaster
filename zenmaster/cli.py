...
_CATEGORIES: dict[str, list[str]] = {
    "Power limits":    ["stapm-limit", "fast-limit", "slow-limit", "ppt-limit",
                        "apu-slow-limit", "fast-spm-limit", "slow-spm-limit",
                        "core-power-limit-offset", "stapm-time", "slow-time"],
    ...
    "Clocks":          ["max-cpuclk", "min-cpuclk", "max-gfxclk", "min-gfxclk",
                        ...
                        "fclk-overclock-on-the-fly", "cclk-fmax-offset",
                        "max-vcn", "min-vcn", "max-lclk", "min-lclk",
                        "oc-clk", "oc-clk-per-core",
                        "set-boost-limit-frequency", "set-vmin-freq"],
    ...
    "Query / get":     ["test", "get-pbo-scalar", "get-sustained-power-and-thm-limit",
                        ...
                        "get-core-performance-order", "get-smu-version",
                        "get-interface-version", "get-metrics-table-version",
                        "get-metrics-table", "get-metrics-table-dram-address",
                        "get-coper", "get-cogfx",
...
_ARG_UNITS: dict[str, str] = {
    ...
    "ppt-limit": "mW", "apu-slow-limit": "mW", "fast-spm-limit": "mW",
    "slow-spm-limit": "mW", "core-power-limit-offset": "mW",
    ...
    "oc-clk": "MHz", "oc-clk-per-core": "MHz",
    "cclk-fmax-offset": "MHz", "max-cpuclk": "MHz",
...
_ARG_DESCS: dict[str, str] = {
    ...
    "fast-spm-limit":            "Fast SPM Power Limit",
    "slow-spm-limit":            "Slow SPM Power Limit",
    "core-power-limit-offset":   "Core power limit offset",
    ...
    "gfx-clk":                   "Forced GFX clock speed",
    ...
    "fclk-overclock-on-the-fly": "FCLK overclock on the fly",
    "cclk-fmax-offset":          "Core clock Fmax offset",
    ...
    "disable-gpuclockoverdrive": "Disable GPU clock overdrive",
    "extra-psm-guardband":       "Extra PSM guardband",
    "extra-psm-guardband-gfx":   "Extra PSM guardband for GFX",
    "get-core-performance-order": "Get core performance order",
    ...
    "fit-limit-scalar":          "FIT limit scalar (PBO scalar on HSMP)",
    ...
    "test":                      "Test HSMP interface",
    "get-pbo-scalar":                   "Query current PBO scalar value",
    "get-smu-version":                  "Query SMU firmware version",
    "get-interface-version":            "Query HSMP interface version",
    "get-metrics-table-version":        "Query metrics table version",
    "get-metrics-table":                "Query metrics table contents",
    "get-metrics-table-dram-address":   "Query metrics table DRAM physical address",
    "get-coper":                        "Query per-core Curve Optimizer setting",
    "get-cogfx":                        "Query iGPU Curve Optimizer setting",
