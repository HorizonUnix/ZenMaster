...
_FAMILY_SOCKET: dict[str, str] = {
    ...
    "Siena":           SOCKET_AM5_V1,
    "Turin":           SOCKET_AM5_V1,
    "TurinDense":      SOCKET_AM5_V1,
    "GraniteRidge":    SOCKET_AM5_V1,
    "DragonRange":     SOCKET_AM5_MOBILE,
    "FireRange":       SOCKET_AM5_FIRERANGE,
    ...
    "Medusa1":         SOCKET_FP10_AM5,
    "OlympicRidge":    SOCKET_FP10_AM5,
    "Medusa2":         SOCKET_FP10_AM5,
    "Dhyana":          SOCKET_AM4_V1,
}
...
_CMD_AM4_V2: list[tuple[str, bool, int]] = [
    ...
    ("chtc-temp",                          False, 0x56),
    ("set-vddcr-soc",                      False, 0x14),
    ("get-fastest-core",                   False, 0x59),
...
_CMD_AM5_MOBILE: list[tuple[str, bool, int]] = [
    ("enable-feature",                     True,  0x03),
    ("disable-feature",                    True,  0x04),
    ("stapm-limit",                        True,  0x4f),
    ("fast-limit",                         True,  0x3e),
...
_CMD_AM5_FIRERANGE: list[tuple[str, bool, int]] = [
    ("enable-feature",                     True,  0x03),
    ("disable-feature",                    True,  0x04),
    ("stapm-limit",                        True,  0x4f),
    ("fast-limit",                         True,  0x3e),
...
_CMD_FP10_AM5: list[tuple[str, bool, int]] = [
    ("test",                               True,  0x01),
    ("get-smu-version",                    True,  0x02),
    ("get-interface-version",              True,  0x03),
    ("get-metrics-table-version",          True,  0x04),
    ("get-metrics-table",                  True,  0x05),
    ("get-metrics-table-dram-address",     True,  0x06),
    ("set-coper",                          True,  0x07),
    ("set-coall",                          True,  0x08),
    ("fast-limit",                         True,  0x09),
    ("vrm-current",                        True,  0x0a),
    ("tdc-limit",                          True,  0x0a),
    ("vrmmax-current",                     True,  0x0b),
    ("edc-limit",                          True,  0x0b),
    ("tctl-temp",                          True,  0x0c),
    ("chtc-temp",                          True,  0x0c),
    ("fit-limit-scalar",                   True,  0x0d),
    ("pbo-scalar",                         True,  0x0d),
    ("enable-oc",                          True,  0x0e),
    ("disable-oc",                         True,  0x0f),
    ("oc-clk",                             True,  0x10),
    ("oc-clk-per-core",                    True,  0x11),
    ("oc-volt",                            True,  0x12),
    ("fclk-overclock-on-the-fly",          True,  0x13),
    ("max-fclk-frequency",                 True,  0x13),
    ("get-core-performance-order",         True,  0x14),
    ("stapm-limit",                        True,  0x15),
    ("ppt-limit",                          True,  0x15),
    ("slow-limit",                         True,  0x16),
    ("vrmgfxmax-current",                  True,  0x17),
    ("vrmsoc-current",                     True,  0x18),
    ("fast-spm-limit",                     True,  0x19),
    ("slow-spm-limit",                     True,  0x1a),
    ("apu-slow-limit",                     True,  0x1a),
    ("get-coper",                          True,  0x1b),
    ("get-cogfx",                          True,  0x1c),
    ("set-gpuclockoverdrive-byvid",        True,  0x21),
    ("disable-gpuclockoverdrive",          True,  0x22),
    ("set-cogfx",                          True,  0x23),
    ("cclk-fmax-offset",                   True,  0x24),
    ("core-power-limit-offset",            True,  0x25),
    ("extra-psm-guardband",                True,  0x26),
    ("extra-psm-guardband-gfx",            True,  0x27),
    ("max-gfxclk",                         True,  0x28),
    ("gfx-clk",                            True,  0x28),
]
...
_SOCKET_COMMANDS: dict[str, list[tuple[str, bool, int]]] = {
    ...
    SOCKET_AM5_MOBILE:  _CMD_AM5_MOBILE,
    SOCKET_AM5_FIRERANGE: _CMD_AM5_FIRERANGE,
    SOCKET_FP10_AM5:    _CMD_FP10_AM5,
}
...
_FLAG_ARGS: frozenset[str] = frozenset({
    ...
    "set-fll-btc-enable", "disable-gpuclockoverdrive", "fclk-overclock-on-the-fly",
    "test",
})
...
def is_hsmp(family: str) -> bool:
    return get_socket(family) == SOCKET_FP10_AM5
