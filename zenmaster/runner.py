...
SOCKET_AM4                        = "AM4"
SOCKET_AM4_FP6                    = "AM4_FP6"
SOCKET_AM4_SP3_sTRX4              = "AM4_SP3_sTRX4"
SOCKET_AM5_SP3_SP5_sTRX4_sTRX5   = "AM5_SP3_SP5_sTRX4_sTRX5"
SOCKET_FP6                        = "FP6"
SOCKET_FP6_FP7_FP8                = "FP6_FP7_FP8"
SOCKET_FP7_FP8                    = "FP7_FP8"
SOCKET_FT5_FP5                    = "FT5_FP5"

_FAMILY_SOCKET: dict[str, str] = {
    "SummitRidge":     SOCKET_AM4_SP3_sTRX4,
    "PinnacleRidge":   SOCKET_AM4_SP3_sTRX4,
    "Naples":          SOCKET_AM4_SP3_sTRX4,
    "Whitehaven":      SOCKET_AM4_SP3_sTRX4,
    "Colfax":          SOCKET_AM4_SP3_sTRX4,
    "RavenRidge":      SOCKET_FT5_FP5,
    "Picasso":         SOCKET_FT5_FP5,
    "Dali":            SOCKET_FT5_FP5,
    "Pollock":         SOCKET_FT5_FP5,
    "FireFlight":      SOCKET_FT5_FP5,
    "Matisse":         SOCKET_AM4,
    "Vermeer":         SOCKET_AM4,
    "Renoir":          SOCKET_AM4_FP6,
    "Lucienne":        SOCKET_AM4_FP6,
    "Cezanne_Barcelo": SOCKET_AM4_FP6,
    "VanGogh":         SOCKET_FP6,
    "Mendocino":       SOCKET_FP6_FP7_FP8,
    "Rembrandt":       SOCKET_FP6_FP7_FP8,
    "PhoenixPoint":    SOCKET_FP7_FP8,
    "PhoenixPoint2":   SOCKET_FP7_FP8,
    "HawkPoint":       SOCKET_FP7_FP8,
    "HawkPoint2":      SOCKET_FP7_FP8,
    "SonomaValley":    SOCKET_FP7_FP8,
    "StrixHalo":       SOCKET_FP7_FP8,
    "StrixPoint":      SOCKET_FP7_FP8,
    "KrackanPoint":    SOCKET_FP7_FP8,
    "KrackanPoint2":   SOCKET_FP7_FP8,
    "Raphael":         SOCKET_AM5_SP3_SP5_sTRX4_sTRX5,
    "DragonRange":     SOCKET_AM5_SP3_SP5_sTRX4_sTRX5,
    "GraniteRidge":    SOCKET_AM5_SP3_SP5_sTRX4_sTRX5,
    "FireRange":       SOCKET_AM5_SP3_SP5_sTRX4_sTRX5,
    "Rome":            SOCKET_AM5_SP3_SP5_sTRX4_sTRX5,
    "CastlePeak":      SOCKET_AM5_SP3_SP5_sTRX4_sTRX5,
    "Milan":           SOCKET_AM5_SP3_SP5_sTRX4_sTRX5,
    "Chagall":         SOCKET_AM5_SP3_SP5_sTRX4_sTRX5,
    "Genoa":           SOCKET_AM5_SP3_SP5_sTRX4_sTRX5,
    "StormPeak":       SOCKET_AM5_SP3_SP5_sTRX4_sTRX5,
    "Bergamo":         SOCKET_AM5_SP3_SP5_sTRX4_sTRX5,
    "Turin":           SOCKET_AM5_SP3_SP5_sTRX4_sTRX5,
    "TurinD":          SOCKET_AM5_SP3_SP5_sTRX4_sTRX5,
    "ShimadaPeak":     SOCKET_AM5_SP3_SP5_sTRX4_sTRX5,
}
...
_CMD_FT5_FP5_AM4: list[tuple[str, bool, int]] = [
    ...
    ("disable-oc",                         False, 0x0e),
    ("oc-clk",                             False, 0x7d),
    ("oc-clk",                             False, 0x41),
    ("oc-clk-per-core",                    False, 0x7e),
    ("oc-clk-per-core",                    False, 0x0d),
    ("oc-clk",                             True,  0x59),
    ("oc-clk-per-core",                    True,  0x5a),
    ("oc-clk",                             True,  0x41),
    ("oc-volt",                            True,  0x5b),
    ("oc-volt",                            False, 0x7c),
    ("oc-volt",                            True,  0x40),
...
_CMD_AM4_V2: list[tuple[str, bool, int]] = [
    ...
    ("oc-clk",                             True,  0x26),
    ("oc-clk",                             False, 0x5c),
    ("oc-clk-per-core",                    True,  0x27),
    ("oc-clk-per-core",                    False, 0x5d),
    ("oc-volt",                            True,  0x28),
    ("oc-volt",                            False, 0x61),
    ("set-coall",                          True,  0x36),
...
_CMD_FP6_AM4: list[tuple[str, bool, int]] = [
    ...
    ("oc-clk",                             True,  0x31),
    ("oc-clk",                             False, 0x19),
    ("oc-clk-per-core",                    True,  0x32),
    ("oc-clk-per-core",                    False, 0x1a),
    ("oc-volt",                            True,  0x33),
    ("oc-volt",                            False, 0x1b),
...
_CMD_FT7_FT8: list[tuple[str, bool, int]] = [
    ("enable-feature",                     True,  0x05),
    ("disable-feature",                    True,  0x07),
    ("stapm-limit",                        True,  0x14),
    ("stapm-limit",                        False, 0x31),
    ...
    ("prochot-deassertion-ramp",           False, 0x3d),
    ("skin-temp-limit",                    True,  0x4a),
    ("apu-slow-limit",                     True,  0x23),
    ("apu-slow-limit",                     False, 0x34),
    ("apu-skin-temp",                      True,  0x33),
    ...
    ("set-coall",                          True,  0x4c),
    ("set-coall",                          False, 0x5d),
    ("get-coper-options",                  False, 0xaf),
    ("get-coper-options",                  False, 0xe1),
    ("get-cogfx-options",                  False, 0x20),
    ("set-boost-limit-freq-all-cores",     False, 0x47),
    ("set-boost-limit-freq-gpu",           False, 0xca),
    ("get-expo-profile-active",            False, 0xdb),
    ("get-ln2-mode",                       False, 0xc4),
    ("get-sustained-power-and-thm-limit",  True,  0x5f),
    ("get-sustained-power-and-thm-limit",  False, 0x65),
    ("get-pbo-fused-power-limit",          False, 0x11),
    ("get-pbo-fused-slow-limit",           False, 0x12),
...
_SOCKET_COMMANDS: dict[str, list[tuple[str, bool, int]]] = {
    SOCKET_AM4_SP3_sTRX4:          _CMD_AM4_V1,
    SOCKET_FT5_FP5:                 _CMD_FT5_FP5_AM4,
    SOCKET_AM4:                     _CMD_AM4_V2,
    SOCKET_AM4_FP6:                 _CMD_FP6_AM4,
    SOCKET_FP6:                     _CMD_FF3,
    SOCKET_FP6_FP7_FP8:             _CMD_FT6_FP7_FP8,
    SOCKET_FP7_FP8:                 _CMD_FT7_FT8,
    SOCKET_AM5_SP3_SP5_sTRX4_sTRX5: _CMD_AM5_V1,
}
